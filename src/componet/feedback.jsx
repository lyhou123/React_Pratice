  ...
  return (
    <figure className="max-w-screen-sm">
      ...
      <figcaption className="mt-6 flex items-center space-x-3">
        <Avatar rounded size="xs" img="https://media.cnn.com/api/v1/images/stellar/prod/210709050012-giant-panda-china-file.jpg?q=x_0,y_0,h_900,w_1599,c_fill/h_833,w_1480" alt="profile picture" />
